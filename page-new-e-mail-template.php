...
<div class="container">
	<div class="row">
		<div class="offset-lg-1 offset-xl-2 col-md-12 col-lg-10 col-xl-8">
			<div class="row pb-4">
				<div class="col-12">
					<div class="float-end text-end mt-2">
						<img src="https://chart.googleapis.com/chart?chs=135x135&cht=qr&chl=https://www.greeting.dk" style="width: 100px;"><br>
						Klik & opdatér<br> ordrestatus
					</div>
					<h1 class="mt-5">I har modtaget en ny bestilling på Greeting.dk</h1>
					<small>❤️ tak for at levere gode gavehilsner. Hold kunden opdateret her ></small>
					<br>
			...
			<div class="row border mb-3">
				<div class="col-6 pt-2">
					...
					<p>
						...
						<br>
						<?php
						$delivery_date2 = '01-02-1997';

						if(!empty($delivery_date2)){
				...
				<div class="col-6 pt-2">
					...
					<p class="text-end">
						...
						<br>
						Hej med dig her er en lang hilsen. Bla bla bla.
					</p>
				</div>
			</div>
			<div class="row order">
