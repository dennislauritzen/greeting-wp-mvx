...
?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center pt-4 pb-5 mb-3 position-relative">
                        <div class="">
                            <svg viewBox="0 0 524 113" width="175" fill="#fecbca"  xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-2 col-xl-2">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/6000-kolding/" aria-label="Gå til bysiden for 6000 Kolding" class="text-white">6000 Kolding</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/6100-haderslev/" aria-label="Gå til bysiden for 6100 Haderslev" class="text-white">6100 Haderslev</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/6700-esbjerg/" aria-label="Gå til bysiden for 6700 Esbjerg" class="text-white">6700 Esbjerg</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/6710-esbjerg-v/" aria-label="Gå til bysiden for 6710 Esbjerg V" class="text-white">6710 Esbjerg V</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/7000-fredericia/" aria-label="Gå til bysiden for 7000 Fredericia" class="text-white">7000 Fredericia</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/7100-vejle/" aria-label="Gå til bysiden for 7100 Vejle" class="text-white">7100 Vejle</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/7400-herning/" aria-label="Gå til bysiden for 7400 Herning" class="text-white">7400 Herning</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/7500-holstebro/" aria-label="Gå til bysiden for 7500 Holstebro" class="text-white">7500 Holstebro</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8000-aarhus-c/" aria-label="Gå til bysiden for 8000 Aarhus C" class="text-white">8000 Aarhus C</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8200-aarhus-n/" aria-label="Gå til bysiden for 8200 Aarhus N" class="text-white">8200 Aarhus N</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8240-risskov/" aria-label="Gå til bysiden for 8240 Risskov" class="text-white">8240 Risskov</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8600-silkeborg/" aria-label="Gå til bysiden for 8600 Silkeborg" class="text-white">8600 Silkeborg</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8800-viborg/" aria-label="Gå til bysiden for 8800 Viborg" class="text-white">8800 Viborg</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8900-randers-c/" aria-label="Gå til bysiden for 8900 Randers C" class="text-white">8900 Randers C</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/8920-randers-nv/" aria-label="Gå til bysiden for 8920 Randers NV" class="text-white">8920 Randers NV</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/9000-aalborg/" aria-label="Gå til bysiden for 9000 Aalborg" class="text-white">9000 Aalborg</a></li>
                            <li class="pb-1"><a href="<?php echo site_url(); ?>/c/9800-hjoerring/" aria-label="Gå til bysiden for 9800 Hjørring" class="text-white">9800 Hjørring</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <p>
                          ...
                          <a href="mailto:<?php echo get_field('greeting_contact_mail_address', 'option'); ?>" aria-label="Skriv en mail til Greeting.dk" class="text-white" style="font-size: 0.9em;"><?php echo get_field('greeting_contact_mail_address', 'option'); ?></a>
                        </p>
                        <p>
                          ...
                          <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                            ...
                            <a href="tel:+45<?php echo get_field('greeting_contact_phone_number', 'option'); ?>" aria-label="Ring til Greeting.dk" class="text-white" style="font-size: 0.9em;">(+45) <?php echo trim(strrev(chunk_split(strrev( get_field('greeting_contact_phone_number', 'option') ),2, ' '))); ?></a>
                        </p>
                        <div class="">
                            <ul class="social m-0 p-0 mt-2">
                                <li class="me-1 me-md-2">
                                    <a href="https://www.facebook.com/greeting.dk" aria-label="Besøg Greeting.dks Facebook-profil" class="text-white">
                                ...
                                <li class="me-1 me-md-2">
                                    <a href="https://www.instagram.com/greeting.dk/" aria-label="Besøg Greeting.dks Instagram-profil">
                                        <figure class="rounded-circle text-center" style="background-color: #ffffff; width: 40px; height: 40px; padding: 7px;">
        ...
        <section id="formal-footer" class="pt-3 pb-1 bg-light-grey">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-8">
                    © <?php echo date("Y"); ?> <?php echo get_field('footer_info_text', 'option'); ?>
                    </div>
                    <div class="col-4">
                        <ul class="float-end m-0 p-0">
                            ...
                            <li class="" aria-label="Master Card logo">
                                <figure>
                                    <svg width="24" height="19" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                        <g>
