...
<section id="citycontent" class="row">
  <div class="container">
    ...
    <a class="btn btn-primary" id="filterModalBtn" data-bs-toggle="modal" href="#filterModal" role="button">Vælg leveringsdato</a>
    <a class="btn btn-primary" id="filterModalBtn" data-bs-toggle="modal" href="#filterModal" role="button">Vælg anledning</a>
    <a class="btn btn-primary" id="filterModalBtn" data-bs-toggle="modal" href="#filterModal" role="button">Vælg kategori</a>
    <a class="btn btn-primary" id="filterModalBtn" data-bs-toggle="modal" href="#filterModal" role="button">Pris</a>
    <?php
      /////////////////////////
              ...
              <div class="modal-body">
                ...
                **/
                ...
                <div class="rounded border-0 rounded-pill bg-light" style="display: inline-block; margin: 5px 5px 4px 0; font-size: 13px;">
                  <label class="" for="modal_filter_delivery_date_<?php echo $k; ?>" style="cursor: pointer; padding: 6px 10px; text-transform: <?php echo ($closed_for_today == 1 ? 'strikethrough;' : ';'); ?>;">
                      <input type="radio" name="modal_filter_del_days_city" class="form-check-input filter-on-city-page" id="modal_filter_delivery_date_<?php echo $k; ?>" value="<?php echo $k; ?>" <?php echo ($closed_for_today == 1 ? 'disabled="disabled" ' : ''); ?> <?php echo ($k == 8 ? 'checked="checked"' : ''); ?>>
