...
<?php
// Get vendor
$vendorId = mvx_find_shop_page_vendor();
      ...
      <div class="modal-dialog modal-fullscreen-lg-down modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" name="guid" id="guid" value="<?php echo hash('crc32c', $vendorId.'-_-'.($vendor->user_data->user_nicename?:'')); ?>">
            <input type="hidden" name="nn" id="nn" value="<?php echo ($vendor->user_data->user_nicename?:''); ?>">
            <input type="hidden" name="gid" id="gid" value="<?php echo $vendorId; ?>">
            ...
            **/
            ...
            if(!empty($productPriceArray)){
                ...
                else if(min($productPriceArray) == max($productPriceArray)){
                    $minProductPrice = 0;
                ...
                $minProductPrice = 0;
                $maxProductPrice = 0;
                $topProductPrice = 0; // or any default value you want
            }
...
do_action('after_mvx_vendor_description', $vendorId);
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <?php
				$vendor_hide_description = apply_filters('mvx_vendor_store_header_hide_description', get_user_meta($vendorId, '_vendor_hide_description', true), $vendorId);
