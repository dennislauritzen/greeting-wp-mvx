 ...
 *
 * Override this template by copying it to yourtheme/dc-product-vendor/emails-old/vendor-notify-shipped.php
 *
...
<?php wc_get_template( 'emails-old/email-addresses.php', array( 'order' => $order ) ); ?>
