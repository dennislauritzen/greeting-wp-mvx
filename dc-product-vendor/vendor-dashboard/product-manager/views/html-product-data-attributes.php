...
<div role="tabpanel" class="tab-pane fade collapsable-component-wrapper" id="product_attributes_data">
    <div class="row-padding">
                ...
                <div class="add-variation-wrapper">
                    <select name="attribute_taxonomy" class="attribute_taxonomy form-control inline-select">
                        <?php if ( apply_filters( 'vendor_can_add_custom_attribute', true ) ) : ?>
                            <option value=""><?php esc_html_e( 'Custom product attribute', 'rigid' ); ?></option>
                        <?php endif; ?>
                        <?php
                    ...
                    <button type="button" class="btn btn-default add_attribute"><?php esc_html_e( 'Add', 'rigid' ); ?></button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="toolbar pull-right">
                    <span class="expand-close">
                        <a href="#" class="expand_all"><?php esc_html_e( 'Expand', 'rigid' ); ?></a> / <a href="#" class="close_all"><?php esc_html_e( 'Close', 'rigid' ); ?></a>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="button-group">
            <button type="button" class="btn btn-default save_attributes button-primary"><?php esc_html_e( 'Save attributes', 'rigid' ); ?></button>
            <div class="toolbar pull-right">
                <span class="expand-close">
                    <a href="#" class="expand_all"><?php esc_html_e( 'Expand', 'rigid' ); ?></a> / <a href="#" class="close_all"><?php esc_html_e( 'Close', 'rigid' ); ?></a>
                </span>
