...
<div class="panel-body panel-content-padding top-order-note">
    <div class="vorder-info-top-left pull-left">
        ...
        <?php 
            ...
            if($parent_order){
                $order_delivery_date = get_post_meta( $parent_order, '_delivery_date', true );
                $order_receiver_info = get_post_meta( $parent_order, 'receiver_info', true );
                if($order_delivery_date){?>
                    <tr>
                        <th><?php esc_html_e( 'Delivery Date', 'dc-woocommerce-multi-vendor' ); ?> :</th>
                        <td><?php echo esc_html($order_delivery_date); ?></td>
                    </tr>
                <?php }
                if($order_receiver_info){?>
                    <tr>
                        <th><?php esc_html_e( 'Receiver Info', 'dc-woocommerce-multi-vendor' ); ?> :</th>
                        <td><?php echo esc_html($order_receiver_info); ?></td>
                    </tr>
                <?php }
            }
        ?>
