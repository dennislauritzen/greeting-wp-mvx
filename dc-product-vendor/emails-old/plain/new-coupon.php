 ...
 *
 * Override this template by copying it to yourtheme/dc-product-vendor/emails-old/plain/new-coupon.php
 *
...
echo '\n'; 
$coupon_link = apply_filters( 'wcmp_email_vendor_new_coupon_link', esc_url( get_edit_post_link( $post_id )));
