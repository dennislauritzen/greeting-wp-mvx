...
<div id="content" class="container">
    ...
    <?php } else if($orderStatus == 'cancelled' || $orderStatus == 'failed' || $orderStatus == 'refunded') {?>
      <a href="<?php echo $update_link; ?>">
      <div class="text-center btn bg-light shadow border border-danger border-1 rounded p-3 w-50">
        ...
        <p><b>Leveret/Afsendt</b><br>Ordren er desværre enten refunderet, slettet eller ikke gennemført, så den kan ikke markeres som leveret</p>
      </div>
      </a>
