...
<style type="text/css">
  ...
  .top-search-input {
	...
	#relatedstores .card .card-img-top {
		width: 100%;
    height: 10vw;
    object-fit: cover;
	}
  ...
  <div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-6">
					<img src="http://greeting/wp-content/uploads/2017/08/m_prod1_1.jpg">
				</div>
				<div class="col-md-12 col-lg-6">
					<h1>Gavekurv "Lækkert mix"</h1>
					...
					<div class="addtocart">
						Indsæt add to cart fra Rigid theme, fungerer meget godt.
					</div>
				</div>
			</div>
		</div>
	...
	<section id="vendor" class="bg-light-grey py-5 mb-5">
		<div class="container">
			<div class="row">
				<div class="col-lg-2">
					<img src="https://dev.greeting.dk/wp-content/uploads/2022/04/119550939_363089735070099_2663604500059929352_n-150x150.jpg">
				</div>
				<div class="col-lg-6">
					<h6>SlikApoteket</h6>
					<p>
					...
					s</p>
					<p>Denne gavehilsen leveres af Slikapoteket på Frederiksberg.
						Slikapoteket pakker altid gaven pænt ind og skriver en håndskrevet hilsen til din modtager.</p>
	...
	<section id="relatedstores">
		<div class="container">
			<div class="row py-5">
				<div clsas="col-12">
					<h4 class="text-center pb-5">Andre butikker, der leverer i 2000 Frederiksberg C</h4>
				</div>
				<div class="col-lg-3">
