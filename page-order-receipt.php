...
<script>
	...
	'user_details': {
		...
		'first_name_sha256': '<?php echo hash('sha256', $order->get_billing_first_name() ? $order->get_billing_first_name() : ''); ?>',
		'last_name': '<?php echo $order->get_billing_last_name(); ?>',
		'last_name_sha256': '<?php echo hash('sha256', $order->get_billing_last_name() ? $order->get_billing_last_name() : ''); ?>',
        ...
        'address_sha256': '<?php echo hash('sha256', $order->get_billing_address_1() ? $order->get_billing_address_1() : ''); ?>',
