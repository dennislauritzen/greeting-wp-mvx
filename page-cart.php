	...
	<div class="container py-5">
		<div class="row">
			<div class="col-12 text-center">
				<h2 class="pb-4"><?php echo get_field('cc_header_h2'); ?></h2>
				<p class="pb-3"><?php echo get_field('cc_text'); ?></p>
			</div>
		</div>
		<div class="row">
        ...
        <p class="pt-2"><?php echo get_field('phone_text'); ?></p>
			</div>
			<div class="col-4 text-center">
        ...
        <p class="pt-2"><?php echo get_field('mail_text'); ?></p>
			</div>
			<div class="col-4 text-center">
        ...
        <p class="pt-2"><?php echo get_field('chat_text'); ?></p>
			</div>
		</div>
	</div>
</section>
