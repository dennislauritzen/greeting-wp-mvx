...
<section id="maintop" class=" position-relative">
    <div class="row g-0">
      <div class="col-12 d-flex  align-items-bottom align-items-md-center align-items-lg-center align-items-xl-center video-wrapper">
        <video loop="true" autoplay="autoplay" muted preload="none"  playsinline id="frontpagevid" poster="https://www.greeting.dk/wp-content/uploads/2023/07/greeting-poster-1-e1690384064701.png" class="position-absolute top-0 start-0" style="pointer-events: none;">
