...
<section id="maintop" class=" position-relative">
    <div class="row g-0">
      <div class="col-12 d-flex  align-items-bottom align-items-md-center align-items-lg-center align-items-xl-center video-wrapper">
        ...
        <div class="col-12 col-md-10 col-lg-6 col-xl-6 bg-teal-75 position-relative start-0 top-0">
            <div class="p-5 m-5 top-text-content">
                ...
                <div class="input-group pb-4 w-100 w-md-75 w-lg-75 w-xl-75">
                    <input type="text" class="form-control border-0 ps-5 pe-3 py-3 shadow-sm rounded" placeholder="Indtast by eller postnr. (eks. 8000)">
                ...
                <ul class="list-inline my-2">
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Aarhus</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Aalborg</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Esbjerg</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Horsens</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Herning</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Kolding</a>
                    </li>
                    <li class="list-inline-item pb-1">
                      <a href="#" class="btn btn-link rounded-pill pb-2 border-1 border-white text-white">Vejle</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 text-center d-flex align-items-center bg-teal text-white" style="height: 35vw; min-height: 500px;">
            <div class="p-2 p-lg-5 p-xl-5">
              <div class="media-text__inner text-right px-lg-4 px-xl-4">
                ...
                <a class="btn bg-white text-teal rounded-pill mt-2 py-3 px-4" href="https://greeting.dk/om-os/" title="Gå til siden: Om Greeting.dk">Om Greeting ></a>
              </div>
            </div>
          </div>
        ...
        <div class="col-12 col-md-6 text-center d-flex align-items-center bg-pink text-teal" style="height: 35vw; min-height: 500px;">
          <div class="p-2 p-lg-5 p-xl-5">
            <div class="media-text__inner text-right px-lg-4 px-xl-4">
              ...
              <a class="btn bg-teal text-white rounded-pill mt-2 py-3 px-4" href="https://greeting.dk/firmagaver/" title="https://greeting.dk/firmagaver/" target="">Læs om firmagaver ></a>
            </div>
          </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-6 text-center d-flex align-items-center bg-yellow text-teal" style="height: 35vw; min-height: 500px;">
            <div class="p-2 p-lg-5 p-xl-5">
                <div class="media-text__inner text-left px-lg-4 px-xl-4">
                    ...
                    <a class="btn bg-white rounded-pill mt-2 py-3 px-4" href="https://greeting.dk/bliv-partner/" title="Gå til siden: Bliv partner" target="">Bliv partner ></a>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-6" style="background-image:url('https://greeting.dk/wp-content/uploads/2021/11/265A7587-aspect-ratio-800-700.jpg');background-size:cover;"></div>
  ...
  <div class="container-fluid text-center mb-3 py-5">
    <div class="row">
      <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
        ...
        <a class="btn bg-teal text-white py-3 px-4 rounded-pill">Mere om Greeting.dk ></a>
      </div>
    </div>
  </div>
</section>
