<section id="pressmentions" class="pressmentions bg-white">
  <div class="container">
    <div class="row pt-4 pb-5 d-none d-lg-block">
      <div class="col-12 pt-2 pb-4 d-flex align-items-center text-center">
    ...
    <div class="row pt-4 pb-5 d-block d-lg-none">
      <div class="col-12 pt-1 pb-3 pb-md-3 d-flex align-items-center text-center">
        <div class="w-100 align-middle" style="font-family: 'Inter',sans-serif;">Greeting.dk har været nævnt i</div>
      </div>
      <div class="col-12">
        <div id="carouselPress" class="carousel slide" data-bs-ride="carousel">
