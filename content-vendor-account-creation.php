<?php
/*
 * Template Name: Create Vendor Account Custom
    ...
    <div class="container py-4">
      <div class="row">
        <div class="d-flex pb-3 pb-lg-0 pb-xl-0 position-relative justify-content-center justify-content-lg-start justify-content-xl-start col-md-12 col-lg-3">
          ...
          <!--<img src="https://www.greeting.dk/wp-content/uploads/2022/04/Greeting-1.png" style="width: 150px;">-->
          <img src="https://www.greeting.dk/wp-content/uploads/2022/04/greeting-logo-white.png" class="img-fluid" style="text-align: center; max-width: 150px;">
          <!-- <img src="https://www.greeting.dk/wp-content/uploads/2022/04/greeting-test.png" style="width: 150px;"> -->
...
<section id="vendorlogin" class="pt-5">
  <div class="container">
    <div class="row">
      <div class="col-12">
